        ...
        <main className={styles.main}>
            ...
            <div className={styles.grid}>
                ...
                >
                    ...
                    <p>Discover insights about actors, including ratings in best genres, directors, and co-actors.</p>
                </a>
                ...
                >
                    ...
                    <p>Find trends in movies, such as decade-based similarity, ratings over the years, and director success in genres.</p>
                </a>
            </div>
